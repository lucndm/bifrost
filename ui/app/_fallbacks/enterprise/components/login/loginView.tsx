...
import { BooksIcon, DiscordLogoIcon, GithubLogoIcon, SignInIcon } from "@phosphor-icons/react";
...
export default function LoginView() {
	...
	const isSSO = authState?.auth_type === "sso";
					...
					{isSSO ? (
						<div className="space-y-5">
							...
							<Button
								...
								onClick={() => {
									setIsLoading(true);
									window.location.href = "/api/session/sso/login";
								}}
								isLoading={isLoading}
								disabled={isLoading}
